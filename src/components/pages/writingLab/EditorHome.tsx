      ...
      <div>
        ...
        <div className="flex gap-4 mt-8 justify-between">
          ...
          <div className="w-2/3 ">
            ...
            />
            <div className="mt-4"><ScrollArea className="h-[80vh]">
              <Editor placeholder="Start typing..." currWordCount={currWordCount} setCurrWordCount={setCurrWordCount} /></ScrollArea>
            </div>
          </div>
