...
const Editor = ({ placeholder,
    ...
    const config = useMemo(() => ({
        ...
        buttons: [
            ...
            'font', 'fontsize', 'paragraph', 'link', 'align', 'selectAll','table','fullsize', 'undo', 'redo', 
        ],
        buttonsXS: [
            'bold', 'italic', 'underline', 'eraser', 'ul', 'ol', 'link', 'undo', 'redo'
        ],
        buttonsSM: [
            'bold', 'italic', 'underline', 'eraser', 'ul', 'ol', 'link', 'undo', 'redo'
        ],
        ...
        removeButtons: [
            'image', 'video', 'file', 'media',   'about',  'hr'
        ],
        removePlugins: [
            'video', 'imageUploader', 'media', 'clipboard', 'dragAndDropFile'
        ],
